...
y = traj.truthState(simpar.statex.ix.position(1),:)';
...
hstart = scatter(traj.truthState(simpar.states.ix.pos(1),1)',...
                 traj.truthState(simpar.states.ix.pos(2),1)',...
                 'filled','g');
hstop =  scatter(traj.truthState(simpar.states.ix.pos(1),end)',...
                 traj.truthState(simpar.states.ix.pos(2),end)',...
                 'filled','r');
x_estimate = traj.navState(simpar.states.ixf.pos(1),:)';
y_estimate = traj.navState(simpar.states.ixf.pos(2),:)';
htraj = plot(x_estimate,y_estimate,'-.');
hold all;
